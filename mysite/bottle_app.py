#Autor: Ygor Trocoli - 2021 -> projeto de bottle
...
def index():
     ...
     return template('/home/ygort/mysite/formulario-crioterapia.html', nome = "-", classificacao = "-", probabilidade = "-")
...
def index_resposta():
    ...
    modelo_NB = joblib.load('/home/ygort/mysite/modelo_crioterapia_MNB.pkl')
    ...
    return template('/home/ygort/mysite/formulario-crioterapia.html', nome = nome, classificacao = classificacao, probabilidade = probabilidade)
